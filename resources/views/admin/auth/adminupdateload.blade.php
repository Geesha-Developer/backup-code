                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="invoicing_payment_terms" style="width: 100%;">
                                                    <option value="Net 30" {{ $post->invoicing_payment_terms == 'Net 30' || empty($post->invoicing_payment_terms) ? 'selected' : '' }}>Net 30</option>
                                                    <option value="Net 7" {{ $post->invoicing_payment_terms == 'Net 7' ? 'selected' : '' }}>Net 7</option>
                                                    <option value="Due On Received" {{ $post->invoicing_payment_terms == 'Due On Received' ? 'selected' : '' }}>Due On Received</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <!-- <input type="number" id="shipper_load_final_rate" name="shipper_load_final_rate" class="form-control" required> -->
                                                     <input type="text" class="form-control" id="shipper_load_final_rate" name="shipper_load_final_rate" value="{{ $post->shipper_load_final_rate }}" readonly  required />
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="modal fade" id="otherChargesModal">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header pt-0">
                                                            <h5 class="modal-title" style="font-size: 17px; text-align: left; margin-left: 9px; font-weight: 700;">Carrier Other Charges</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            ...
                                                            @foreach($carrierCharges as $index => $carrierCharge)
                                                                <div class="row charge-row" style="margin-top: 10px;">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control typeofcharge" placeholder="Enter Charge Type" name="shipper_type_charge[]" value="{{ htmlspecialchars($carrierCharge['type'] ?? '') }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-5">
                                                                        <div class="form-group">
                                                                            <input type="text" step="0.01" class="form-control otheramount" placeholder="Enter amount" name="shipper_other_charge[]" value="{{ number_format($carrierCharge['amount'] ?? 0, 2) }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-1 text-center" style="margin-top: 6px;">
                                                            ...
                                                            <div class="text-center mt-3">
                                                                <button type="button" class="btn btn-success create-input" style="font-size: 14px;">Add New Charges</button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id="chargeRowTemplatecarrier" style="display:none;">
                                                        <div class="row charge-row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control typeofcharge" placeholder="Enter Charge Type" name="shipper_type_charge[]">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                    ...
                                    <table class="table-bordered table-striped" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="shipperRow{{ $key + 1 }}">
                                                ...
                                                <td style="padding: 7px;">
                                                    <input class="form-control" style="width: 160px;" name="load_shipper_commodity_type{{ $key + 1 }}" value="{{ $shipperType[$key]['commodity_type'] ?? '' }}" >
                                                </td>
                                                <td style="padding: 7px;">
                                                    <input class="form-control" style="width: 120px;" name="load_shipper_commodity{{ $key + 1 }}" required value="{{ $shipperCommodity[$key]['commodity_name'] ?? '' }}" required>
                                                </td>
                                                <td style="padding: 7px;">
    ...
    <table class="table-bordered">
        ...
        @foreach ($consigneeData as $key => $consignee)
            <tr id="consigneeRow{{ $key + 1 }}">
                ...
                <td style="padding: 7px;">
                    <input class="form-control" style="width: 120px;" name="load_consignee_commodity_{{ $key + 1 }}" value="{{ $consigneeCommodity[$key]['consignee_commodity'] ?? '' }}" required>
                </td>
                <td style="padding: 7px;">
                ...
                <td style="padding: 7px;">
                    <input class="form-control" style="width: 250px;" name="load_consignee_discription_{{ $key + 1 }}" value="{{ $consigneeDescription[$key]['description'] ?? '' }}">
                </td>
                <td style="padding: 7px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" readonly required name="carrier_country" id="country" value="{{ preg_replace('/^\d+\s*/', '', optional($load->carrier)->carrier_country ?? '') }}
" style="width: 100%;  ">
                                </div>
                            </div>
                            <div class="col-md-3">
...
$(document).ready(function () {
    ...
    $('#btnAddConsignee').on('click', function () {
        ...
        <tr id="consigneeRow${consigneeCounter}">
           ...
           @foreach($consigneeLocation as $key => $location)
    <td style="padding: 7px;">
        <input class="form-control" name="load_consignee_location_{{ $key }}" 
            id="load_consignee_location_{{ $key }}" 
