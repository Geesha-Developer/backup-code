        ...
        <div class="block-header">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="customers" role="tabpanel" aria-labelledby="customers-tab">
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered js-exportable" id="dataTable" data-page-length="50">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="dynamic-data">{{ number_format($rc->revenue_difference, 2) }}</td>
                            ...
                            <tbody>
                                @foreach($dashboard as $load)
                                    ...
                                    @endphp
                                        ...
                                        <td class="dynamic-data">
                                            {{ isset($consignee_appointment[0]['appointment']) && \Carbon\Carbon::hasFormat($consignee_appointment[0]['appointment'], 'm-d-Y') 
                         ...
                         <table class="table table-bordered dataTable js-exportable" id="dataTable" data-page-length="50">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="dynamic-data">
                                    @if($log->invoice_status == 'Paid' && $log->load_status == 'Delivered')
                                    Invoiced
                                    @elseif($log->load_status == 'Delivered' && $log->invoice_status == 'Paid Record')
                                        Invoiced and Paid
