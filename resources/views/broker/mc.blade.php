                    ...
                    <div class="card">
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered js-basic-example dataTable" data-page-length="50">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $i++ }}</td>
                                                <td>{{ $m->carrier_mc_ff_input }}</td>
                                                <td>{{ $m->carrier_dot ? $m->carrier_dot : 'NA' }}</td>
                                                <td>{{ $m->carrier_name }}</td>
                                                <td>{{ $m->carrier_email }}</td>
                                                <td>{{ $m->carrier_telephone }}</td>
                                                <td>{{ $m->carrier_commodity_type }}</td>
                                                <td>{{ $m->carrier_commodity_name }}</td>
                                                <td>{{ $m->carrier_commodity_value }}</td>
                                                <td>{{ $m->carrier_equipment_type }}</td>
                                                <td>{{ $m->carrier_mc_purpose }}</td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close mt-0" data-dismiss="modal" style="color: #000;font-size: 22px; top: 16px;">&times;</button>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="carrier_mc_ff_input" class="form-control" required style="width: 100%;">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>DOT Number <code>*</code></label>
                                <input type="number" name="carrier_dot" class="form-control" required style="width: 100%;">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Carrier Email</label>
                                <input type="email" name="carrier_email" class="form-control" style="width: 100%;">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Contact Number</label>
                                <input type="number" name="carrier_telephone" class="form-control" style="width: 100%;">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Commodity Type <code>*</code></label>
                                <input type="text" name="carrier_commodity_type" class="form-control select2" required style="width: 100%;height:30px;padding: 0px 0 0 10px;">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Commodity Name </label>
                                <input type="text" name="carrier_commodity_name" class="form-control select2" style="width: 100%;height:30px;padding: 0px 0 0 10px;">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Commodity Value <code>*</code></label>
                                <input type="number" name="carrier_commodity_value" class="form-control select2" required style="width: 100%;height:30px;padding: 0px 0 0 10px;">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Equipment Type<code>*</code></label>
                                <select class="form-control select2" name="carrier_equipment_type" id="load_equipment_type" style="width: 100%;" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="carrier_mc_purpose" class="form-control" required style="width: 100%;">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Commodity Value Proof <code>*</code></label>
                                <input class="form-control" type="file" id="myFile" name="carrier_commodity_value_proof" style="    height: 91px !important; padding: 27px 11px;">
                            </div>
                        </div>
                    </div>
